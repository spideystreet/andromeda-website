      ...
      {items.map((item) => (
        ...
        >
          ...
          <Image
            ...
            alt={item.name}
            className={cn(
              "object-cover !m-0 !p-0 object-top h-14 w-14 border-2 group-hover:scale-105 group-hover:z-30 border-background relative transition duration-500 rounded-full",
              className
            )}
          />
        </div>
